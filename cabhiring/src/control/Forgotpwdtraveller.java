...
/**
 * Servlet implementation class Forgotpwdtraveller
 */
@WebServlet("/Forgotpwdtraveller")
public class Forgotpwdtraveller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		tr.setEmail(email);
		String travellerpwd=tr.travellerforgotpassword();
		PrintWriter pw=response.getWriter();
		///pw.print(travellerpwd);
		...
		response.setContentType("text/plain");	
	        ...
	        //} 
              ...
              //  message.setSubject(subject);
                ...
                messageBodyPart.setText(body +""+travellerpwd);
